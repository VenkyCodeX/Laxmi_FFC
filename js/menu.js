...
const menuLang = {
  en: {
    ...
    dishes: {
      ...
      'chicken lollypop':       'Chicken Lollypop (6 pcs)',
      'chicken leg piece':      'Chicken Leg Piece',
  ...
  hi: {
    ...
    dishes: {
      ...
      'chicken lollypop':       'चिकन लॉलीपॉप (6 पीस)',
      'chicken leg piece':      'चिकन लेग पीस', {
    ...
    dishes: {
      ...
      'chilli chicken':         'चिली चिकन',
      'chicken lollypop':       'चिकन लॉलीपॉप (6 पिसेस)',
      'chicken leg piece':      'चिकन लेग पिस',
