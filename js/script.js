...
const translations = {
  en: {
    ...
    heroTagline: 'Hot & Spicy Street Food in <strong>Shankar Nagar, Nanded</strong>',
    ...
    contactLocVal: 'Shankar Nagar, Nanded,<br/>Maharashtra – 431605',
    contactHoursVal: 'Mon – Sun<br/>11:00 AM – 11:00 PM',
    contactWAVal: 'Chat to Order',
    footerTagline: 'Hot & Spicy Street Food in Shankar Nagar, Nanded',
  ...
  hi: {
    ...
    heroTagline: 'शंकर नगर, नांदेड़ में <strong>गरम और मसालेदार</strong> स्ट्रीट फूड',
    ...
    contactLocVal: 'शंकर नगर, नांदेड़,<br/>महाराष्ट्र – 431605',
    contactHoursVal: 'सोम – रवि<br/>सुबह 11:00 – रात 11:00',
    contactWAVal: 'ऑर्डर के लिए चैट करें',
    footerTagline: 'शंकर नगर, नांदेड़ में गरम और मसालेदार स्ट्रीट फूड',
